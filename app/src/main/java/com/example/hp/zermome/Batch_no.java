...
public class Batch_no extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name_of_crop=(TextView)findViewById(R.id.message);

        crop_name=message.split("/");
        txtView.setText(crop_name[0]);
        name_of_crop.setText(crop_name[1]+" crop added Successfully");

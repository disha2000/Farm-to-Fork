...
public class MarketRegistration extends AppCompatActivity {





    EditText name, password, phone_no, contact_no, location,licence;
    int request = 100;
    String text_name, text_phone, text_password, gender, location_text, DOB_text, contact_no_text,licence_No;
    ...
    public void Register(View view) {
      ...
      //  licence_No=licence.getText().toString();
    ...
    private void updateuserInfo() {
        ...
        remaining_info.put("Occupation","Market");
        //remaining_info.put("Licnece",licence_No);
                                    ...
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()) {
                                                waiting_dialog.dismiss();
                                                Toast.makeText(getApplicationContext(), "register complete", Toast.LENGTH_LONG).show();
                                                Intent intent = new Intent(getApplicationContext(), Account_created_market.class);;
                                                intent.putExtra("message", text_name);
                                                startActivity(intent);

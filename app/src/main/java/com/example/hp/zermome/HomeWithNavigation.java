...
import com.example.hp.zermome.Fragement.Select_crop;
import com.example.hp.zermome.Fragement.newfeature;
...
public class HomeWithNavigation extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            getSupportFragmentManager().beginTransaction().replace(R.id.container,new Select_crop()).commit();
            overridePendingTransition( R.anim.trans_left_in, R.anim.trans_left_out );


        } else if (id == R.id.nav_share) {

            getSupportFragmentManager().beginTransaction().replace(R.id.container,new newfeature()).commit();
            overridePendingTransition( R.anim.trans_left_in, R.anim.trans_left_out );

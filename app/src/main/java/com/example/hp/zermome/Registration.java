...
Registration extends AppCompatActivity {
    ...
    EditText name, password, phone_no, DOB, location,district_editext,adharcard_no_editText;
    int request = 100;
    String text_name, text_phone, text_password, gender, location_text, DOB_text,district_text,adhar_card_text;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       adharcard_no_editText=(EditText) findViewById(R.id.adharcardno);
       district_editext=(EditText) findViewById(R.id.districtvalue);
    ...
    public void Register(View view) {
        ...
        adhar_card_text=adharcard_no_editText.getText().toString();
        district_text=district_editext.getText().toString();
        ...
        if (adhar_card_text.length() == 0) {
            location.setError("Please Enter location");
            location.requestFocus();
        }
        if (district_text.length() == 0) {
            location.setError("Please Enter location");
            location.requestFocus();
        }else {
    ...
    private void updateuserInfo() {
        ...
        remaining_info.put("District", district_text);
        remaining_info.put("Adharcardno", adhar_card_text);
        ...
        if (uri == null) {
            uri = Uri.parse(ContentResolver.SCHEME_ANDROID_RESOURCE +
                    "://" + this.getResources().getResourcePackageName(R.drawable.man)
                    + '/' + this.getResources().getResourceTypeName(R.drawable.man)
                    + '/' + this.getResources().getResourceEntryName(R.drawable.man));
        }

...
import com.example.hp.zermome.Fragement.Processor_crop;
...
public class For_Processor extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            getSupportFragmentManager().beginTransaction().replace(R.id.container,new HomeFragment_for_processor()).commit();
            overridePendingTransition( R.anim.trans_left_in, R.anim.trans_left_out );

        } else if (id == R.id.Add_Crop) {
            getSupportFragmentManager().beginTransaction().replace(R.id.container,new Processor_crop()).commit();
            overridePendingTransition( R.anim.trans_left_in, R.anim.trans_left_out );
            ...
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    Intent homeintent=new Intent(For_Processor.this,RetailerLogin.class);
